...
// will need to allocate enough memory to hold all of the char* pointers so:
// keep track of the size of char** array and then use realloc
// to make the array larger over time, so that theres enough space for the
